...
XS_EUPXS(XS_HiPi__Utils_drop_permissions_id); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_HiPi__Utils_drop_permissions_id)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
...
XS_EXTERNAL(boot_HiPi__Utils)
{
    ...
    XS_VERSION_BOOTCHECK;
        ...
        newXS("HiPi::Utils::drop_permissions_id", XS_HiPi__Utils_drop_permissions_id, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
